...
class Coupon(models.Model):
    ...
    discount_type = models.CharField(max_length=20, choices=[('PERCENTAGE', 'Percentage'), ('FIXED_VALUE', 'Fixed Value')])
...
class Cart(models.Model):
    ...
    status = models.CharField(max_length=20, default='ACTIVE', choices=[('ACTIVE', 'Active'), ('FINISHED', 'Finished'), ('ABANDONED', 'Abandoned')])
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
